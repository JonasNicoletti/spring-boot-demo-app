...
public class SwaggerController {
    ...
    public Object swaggerResources() {
        return ImmutableList.of(ImmutableMap.of("name", "default", "url", "/v2/api-docs", "location", "/v2/api-docs",
                "swaggerVersion", "2.0"));
    }
    ...
    public Object swaggerUiConfig() {
        return "{\"deepLinking\":true," + "\"displayOperationId\":false," + "\"defaultModelsExpandDepth\":1,"
                ...
                + "\"validatorUrl\":\"\"," + "\"apisSorter\":\"alpha\"," + "\"jsonEditor\":false,"
